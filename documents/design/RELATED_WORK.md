...
**SNAVA는 XC7A200T보다 큰 Kintex-7 325T를 쓰고도 시냅스 20,000개에서 멈춘다.** 온칩 BRAM만 쓰기 때문이다. 본 제안은 DDR3 1GB에 **5.2M 시냅스(40모델 × 130,176)** 를 두고 캐시 계층으로 접근한다. DDR3 1 GB면 같은 크기의 모델을 8,000개 이상 담을 수 있다. 규모가 두 자릿수 이상 차이 난다.
