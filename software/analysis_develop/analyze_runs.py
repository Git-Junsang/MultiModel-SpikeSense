"""학습 기록 폴더(analysis_data/...) 아래 학습 기록(history.csv)을 모아 에포크·배치 판단 자료를 만든다.

출력: <분석폴더>/summary.csv, <분석폴더>/curves_<그룹>.png
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else "../analysis_data")
